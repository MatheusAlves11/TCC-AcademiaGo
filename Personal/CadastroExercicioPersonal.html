  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
   ...
   <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="ListagemExerciciosPersonal.html">Exercício</a>
      </li>
      <li class="nav-item">
        ...
        <form class="row">
          ...
          <div class="col-md-4 mb-4">
            <select class="form-select form-control">
              <option selected>Musculo</option>
              <option value="1">Peito</option>
              <option value="2">Costas</option>
              <option value="3">Bíceps</option>
              <option value="4">Tríceps</option>
              <option value="5">Ombro</option>
              <option value="6">Perna</option>
              <option value="7">Abdomen</option>
              <option value="8">Trapézio</option>
            </select>
          </div>

          <div class="col-md-4 mb-4">
            <input type="number" class="form-control" id="number" placeholder="Séries">
          </div>

          <div class="col-md-4 mb-4">
            <input type="number" class="form-control" id="number" placeholder="Repetições">
          </div>

          <div class="col-md-4 mb-4">
            <input type="number" class="form-control" id="number" placeholder="Descanso">
          </div>
